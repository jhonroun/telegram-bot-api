...
```bash
go get -u github.com/go-telegram-bot-api/telegram-bot-api/v6
```
...
[bot-api-docs]: https://pkg.go.dev/github.com/go-telegram-bot-api/telegram-bot-api/v6?tab=doc#BotAPI
...
import (
	...
	tgbotapi "github.com/go-telegram-bot-api/telegram-bot-api/v6"
)
